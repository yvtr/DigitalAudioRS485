...
#define LCDA_CS_Pin LL_GPIO_PIN_4
#define LCDA_CS_GPIO_Port GPIOC
#define LCDB_CS_Pin LL_GPIO_PIN_5
#define LCDB_CS_GPIO_Port GPIOC
#define LCD_RST_Pin LL_GPIO_PIN_0
#define LCD_RST_GPIO_Port GPIOB
#define LCD_DC_Pin LL_GPIO_PIN_2
#define LCD_DC_GPIO_Port GPIOB
#define KBDB_LEFT_UP_Pin LL_GPIO_PIN_8
#define KBDB_LEFT_UP_GPIO_Port GPIOC
#define SHR_DIN_KBD_LED_B_Pin LL_GPIO_PIN_10
#define SHR_DIN_KBD_LED_B_GPIO_Port GPIOA
#define KBDB_RIGHT_UP_Pin LL_GPIO_PIN_11
#define KBDB_RIGHT_UP_GPIO_Port GPIOC
