...
NR == 6 { printf("#define GIT_DATE_YEAR %u\n", $0);         }
NR == 7 { printf("#define GIT_DATE_MONTH %u\n", $0);        }
NR == 8 { printf("#define GIT_DATE_DAY %u\n", $0);          }
NR == 9 { printf("#define GIT_DATE_HOUR %u\n", $0);         }
NR ==10 { printf("#define GIT_DATE_MIN %u\n", $0);          }
NR ==11 { printf("#define GIT_DATE_SEC %u\n", $0);          }
